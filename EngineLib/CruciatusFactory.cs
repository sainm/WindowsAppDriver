...
namespace EngineLib
{
    ...
    public static class CruciatusFactory
    {
        ...
        /// </summary>
        public static WindowAppElement FocusedElement
        {
            get
            {
                return new WindowAppElement(null, AutomationElement.FocusedElement, null);
            }
        }
        ...
        /// </summary>
        public static WindowAppElement Root
        {
            get
            {
                return new WindowAppElement(null, AutomationElement.RootElement, null);
            }
        }
